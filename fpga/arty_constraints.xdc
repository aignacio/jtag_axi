...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 PULLUP TRUE } [get_ports { trstn }]; #IO_0_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { tck }]; #IO_L4P_T0_15 Sch=ja[2]
...
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { tdo }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
